              ...
              builder: (context, snapshot) {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    print(snapshot.data!.docs[index].data()['imageURL']);
                    return Row(
                      children: [
                         Expanded(
                          child: TaskCard(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: snapshot.data!.docs[index].data()['imageURL'] == null ? null 
                            : DecorationImage(image: NetworkImage(snapshot.data!.docs[index].data()['imageURL'],
                            ),
                            ),
